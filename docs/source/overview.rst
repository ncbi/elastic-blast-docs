...
AWS and GCP also have more limited Free Tiers.  Read about the AWS one `here <https://aws.amazon.com/free/?all-free-tier.sort-by=item.additionalFields.SortRank&all-free-tier.sort-order=asc&awsf.Free%20Tier%20Types=*all&awsf.Free%20Tier%20Categories=*all>`_ and the GCP one `here <https://cloud.google.com/free>`_.  While these are a good way to learn about the cloud, they may be too limited for you to effectively use ElasticBLAST.
