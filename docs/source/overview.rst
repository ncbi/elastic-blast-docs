...
Finally, it shuts down all these instances when the search is over.  You can start an ElasticBLAST run from
...
* After the search is over, ElasticBLAST deletes the resources but not the results.  
